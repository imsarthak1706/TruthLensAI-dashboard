...
export function ThreatActivityChart() {
  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-6">
        <div>
          ...
          <p className="font-body-sm text-body-sm text-on-surface-variant">
            Detection telemetry aligned with 12.4k total scan baseline
          </p>
        </div>
      ...
      {/* Chart Canvas */}
      <div className="w-full h-64 border border-outline-variant/30 rounded bg-surface-container-lowest relative overflow-hidden p-2">
